...
from tests.contexts.fundingrequest.fixtures import NATURE_EISSN, NATURE_JOURNAL_TITLE
...
from tests.contexts.fundingrequest.fixtures.metadata import article_metadata, book_metadata
