...
@method_decorator(breadcrumb("Creditors", parent_url_name="invoices:finances_home"), name="dispatch")
...
@method_decorator(breadcrumb("Creditor Detail", parent_url_name="invoices:creditor_list"), name="dispatch")
...
@method_decorator(breadcrumb("Create Creditor", parent_url_name="invoices:creditor_list"), name="dispatch")
...
@method_decorator(breadcrumb("Edit Creditor", parent_url_name="invoices:creditor_detail"), name="dispatch")
