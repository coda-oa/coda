...
from coda.vocabulary import ConceptId, VocabularyId
...
def disallow_concept(vocabulary_id: VocabularyId, concept_id: ConceptId) -> None:
...
def allow_concept(vocabulary_id: VocabularyId, concept_id: ConceptId) -> None:
    limited = vocabulary_repository.get_limited_by_id(vocabulary_id)
